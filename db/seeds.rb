...
student1 = Student.create!(first_name: 'Dan', last_name: 'Dobrick', devise_id: user1.id, is_crasher: true, is_host: false, school: 'Hard Knocks', crashable: false, zip: 60640)
student2 = Student.create!(first_name: 'Dave', last_name: 'Nestoff', devise_id: user2.id, is_crasher: false, is_host: true, school: 'School of Rock', crashable: true, crashable_type: 'Bedroom', zip: 44070, hosting_zip: 44070)
student3 = Student.create!(first_name: 'Benedict', last_name: 'Schurwanz', devise_id: user3.id, is_crasher: true, is_host: true, school: 'The Derek Zoolander Center For Kids Who Can\'t Read Good And Wanna Learn To Do Other Stuff Good Too', crashable: false, crashable_type: 'Couch', zip: 60640, hosting_zip: 60640)
